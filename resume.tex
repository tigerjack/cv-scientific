...
\isodash{-}%
% \newcommand{\yearrange}[2]{#1--\ifnum#2>99\relax\else#1\fi\the\numexpr#1+#2\relax}
...
\begin{rSection}{Education}
  % PHD
  \begin{rSubsection}{Politecnico di Milano}{since \printdate{2019-11-01}}{Ph.D.\ candidate}{Milan}
  ...
  \end{rSubsection}
  % MASTER
  \begin{rSubsection}{Politecnico di Milano}{\printdate{2019-04-17}}{M.Sc.\ degree}{Milan}
  ...
  \end{rSubsection}
  % 
  \begin{rSubsection}{IELTS}{\printdate{2016-02-01}}{English certificate}{}
...
\begin{rSection}{Teaching Experience}
  ...
  \begin{rSubsection}{Teaching assistant}{\daterange{2020-11-01}{2023-12-31}}{Computer Architectures and Operating Systems}{Prof.\ Gerardo Pelosi}
  ...
  \item Topics addressed (partial): parallel programming (processes, threads),
    ...
    systems and I/O.
  \end{rSubsection}
  \begin{rSubsection}{Teaching assistant}{\daterange{2022-11-01}{2024-01-31}}{Computer Architectures and
  ...
  \item Topics addressed (partial): parallel programming (processes, threads),
    ...
    systems and I/O.
  \end{rSubsection}
  \begin{rSubsection}{Teaching assistant}{\daterange{2023-11-01}{2024-01-31}}{Computer Architectures and
  ...
  \item Topics addressed (partial): parallel programming (processes, threads),
    ...
    systems and I/O.
  \end{rSubsection}
  \begin{rSubsection}{Teaching assistant}{\daterange{2021-11-01}{2022-06-30}}{Informatica (per Aerospaziali)}{Prof.\ Gerardo Pelosi}
  ...
  \end{rSubsection}
\begin{rSubsection}{Teaching tutor}{\daterange{2018-11-24}{2019-01-17}}{Informatica (per Ambientali)}{Prof.\ Andrea Bonarini}
...
\end{rSubsection}
\begin{rSubsection}{Teaching tutor}{\daterange{2016-11-31}{2017-01-31}}{Computer Architectures and Operating Systems}{Prof.ssa Anna Maria Antola}
